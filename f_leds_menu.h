...
void leds_key_modulation(uint32_t my_modulation) { // switch de choix de la source de g_Modulation + configurations pour les MOD VCO + configuration des LFO mod
	...
	if ( (my_modulation == LFO1_MOD) && ( (curent_config.c_LFO1_WF == WF_AR) || (curent_config.c_LFO1_WF == WF_AR2) ) )  test = 0;
	if ( (my_modulation == LFO2_MOD) && ( (curent_config.c_LFO2_WF == WF_AR) || (curent_config.c_LFO2_WF == WF_AR2) ) )  test = 0;
	if ( (my_modulation == LFO3_MOD) && ( (curent_config.c_LFO3_WF == WF_AR) || (curent_config.c_LFO3_WF == WF_AR2) ) )  test = 0;
